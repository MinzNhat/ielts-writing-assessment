...
import FancyFadeIn from '@/features/landing_page/components/FancyFadeIn';

const Footer = () => {
	return (
		<section className="flex flex-col items-center justify-center gap-6 sm:gap-8 md:gap-10 pb-10 overflow-hidden text-gray-800 dark:text-white mt-20">
			<FancyFadeIn>
				<div className="relative z-10 w-full">
					<div className="flex flex-col md:flex-row items-center justify-between gap-10 w-full max-w-5xl mx-auto">
						{/* Info */}
